        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col items-center gap-4 md:gap-6">
            ...
            <div className="flex gap-4 md:gap-6 mt-2 md:mt-4">
              <a href="#" className="w-12 h-12 flex items-center justify-center rounded-full transition duration-300 transform hover:scale-110 hover:shadow-lg" style={{ background: 'linear-gradient(135deg, #4d8ac9 0%, #3a6ba5 100%)' }} aria-label="LinkedIn">
              ...
              <a href="#" className="w-12 h-12 flex items-center justify-center rounded-full transition duration-300 transform hover:scale-110 hover:shadow-lg" style={{ background: 'linear-gradient(135deg, #4d8ac9 0%, #3a6ba5 100%)' }} aria-label="GitHub">
                <svg className="w-6 h-6" fill="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="#" className="w-12 h-12 flex items-center justify-center rounded-full transition duration-300 transform hover:scale-110 hover:shadow-lg" style={{ background: 'linear-gradient(135deg, #4d8ac9 0%, #3a6ba5 100%)' }} aria-label="Instagram">
                <svg className="w-6 h-6" fill="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
